...
source_directory_path = r"C:\Users\ge27xix\SEC\Processed10-X\10Q"

# Destination directory for moving files
destination_directory = r"C:\Users\ge27xix\SEC\Processed10-X\10Q_Useless"
...
for dirpath, dirnames, filenames in os.walk(source_directory_path):
    for filename in filenames:
        ...
        if filename.endswith(".csv") and ("10-Q-A" in filename or "10QSB-A" in filename or "10-Q405-A" in filename or "10QSB40-A" in filename or "10-QT-A" in filename or filename.startswith("XXXXX")):
